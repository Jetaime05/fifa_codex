...
const actionCodes: Record<string, GameAction["type"]> = {
  KeyJ: "pass", KeyU: "throughPass", KeyI: "lobPass", KeyO: "cross", KeyK: "shoot", KeyP: "chipShot",
  KeyL: "tackle", Tab: "switchPlayer", KeyC: "switchCamera", KeyR: "restart", Space: "pause"
};
...
export class KeyboardInput {
  ...
  private readonly onDown = (event: KeyboardEvent) => {
    ...
    if (action && !wasDown) {
      ...
      this.actionQueue.push({ type: action });
    }
  };
